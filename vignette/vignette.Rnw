...
<<check.chr>>=
GenomicRanges::seqlevels(Conrad.hg19.common.CNVs)
@ 
...
The ExomeDepth package includes a plot function for ExomeDepth objects. This function shows the ratio between observed and expected read depth.
